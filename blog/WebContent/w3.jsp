...
<body>
<% 
ArrayList<Text> list = (ArrayList<Text>)request.getAttribute("textByTitle");
%>
<div id="wrapper">
  <header>
  ...
  <div class="container">
    <div class="con_content">
      <div class="about_box">
        <h2 class="nh1"><span>您现在的位置是：<a href="/" target="_blank">网站首页</a>><a href="#" target="_blank">【你就是你自己，别相信任何人对你的评价】</a></span><b>【你就是你自己，别相信任何人对你的评价】</b></h2>
        <div class="f_box">
        <% for(Text text:list){ %>
          <p class="a_title"><%=text.getTitle() %></p>
          <% 
         	 } 
          %>
          <p class="p_title"></p>
            <p class="box_p"><span>发布时间：2017-11-01 17:40:42</span><span>编辑：谈同</span><span>来源：网络</span><span>点击：16012</span></p>
          <!-- 可用于内容模板 -->
        </div>
...
<div class="shang_a">
          ...
          <script src="js/shang.js"></script>   </div>
    </div>
    <div class="blank"></div>
  </div>
  <!-- container代码 结束 -->
