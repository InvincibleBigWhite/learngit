...
.login-box{width:410px;margin:120px auto 0 auto;text-align:center;padding:30px;background:url(images2/mask.png);border-radius:10px;}
...
<div class="login-box">
	...
	<form method="post" action="loginServlet">
		<div class="name">
			<label>管理员账号：</label>
			<input type="text" name="name" id="a" tabindex="1" autocomplete="on" value="<%=username%>"/>
		</div>
		<div class="password">
			<label>密  码：</label>
			<input type="password" name="password" maxlength="16" id="" tabindex="2" id="b" value="<%=password %>"/>
		</div>
	<!-- 	<div class="code">
			<label>验证码：</label>
			<input type="text" name="" maxlength="4" id="code" tabindex="3"/>
			<div class="codeImg">
				<img src="images2/captcha.jpeg.jpg" />
			</div>
		</div> -->
		<div class="remember">
			<input type="checkbox" id="remember" tabindex="4" name="loginCookie"  checked="checked" value="sss"/>
			<label>记住密码</label>
		</div>
		<div class="login">
...
<div class="bottom">©2014 Leting <a href="javascript:;" target="_blank">关于</a> <span>京ICP证030173号</span><img width="13" height="16" src="images2/copy_rignt_24.png" /></div>

<div class="screenbg">
	<ul>
		<li><a href="javascript:;"><img src="images2/0.jpg"></a></li>
		<li><a href="javascript:;"><img src="images2/1.jpg"></a></li>
		<li><a href="javascript:;"><img src="images2/2.jpg"></a></li>
	</ul>
</div>
