...
<div id="wrapper">
  ...
  <SCRIPT type=text/javascript>
	...
	$(function() {
     ...
     <div class="post_body">
   	...
   	<% HashMap map = (HashMap)session.getAttribute("manageRequest1");
		ArrayList<Text> list = (ArrayList)map.get("1");
		Manage manage = (Manage)map.get("2");
		for(Text text:list){
	...
	<table class="table table-bordered" align="center">  
      	...
      	<tr>
      		<td><%= text.getTitle() %></td>
      		<td><a href="../deleteServlet?id=<%=text.getId() %> " class="btn btn-info">删除</a></td>
      		<td><a data-toggle="modal" href="#static" class="btn btn-info" data-placement="bottom" data-original-title="查看客户详情">编辑</a></td>
  ...
  <%
      ...
      %>  
  <tr>
     <td>共<%=manage.getPageCount() %>页&nbsp&nbsp&nbsp&nbsp
     	<a href="../pagingTextServlet?page=<%=manage.getCurrentPage()-1%>"  class="btn btn-info">上一页</a>&nbsp&nbsp&nbsp&nbsp第
     	<input disabled="disabled" type="text" style="width:10px;height:21px" value="<%= manage.getCurrentPage()%>">页&nbsp&nbsp&nbsp&nbsp
     	<a href="../pagingTextServlet?page=<%=manage.getCurrentPage()+1%>" class="btn btn-info">下一页</a>
     </td>
     
      <td>
     	<form action="../pagingTextServlet" method="get">
     		<input name="Submit" class="btn btn-info" value="跳转" type="submit">
     		<input type="text" style="width:10px;height:21px" id="page" name="page">
     	</form>
     </td>
    </tr>
</body>
